...
import { Heart, Star, Users, Clock, Trophy, Zap, Home, Gamepad2 } from 'lucide-react';
...
const FavoritosPage = () => {
  ...
  const nilFavorites = {
    avatar: "👨‍💻",
    name: "Nil",
    description: "Estratega empedernido y amante de los euros",
    favorites: [
      { category: "Mejor juego para 2", game: "Jaipur", icon: Users },
      { category: "Juego de cartas favorito", game: "7 Wonders", icon: Gamepad2 },
      { category: "Juego de estrategia favorito", game: "Wingspan", icon: Trophy },
      { category: "Mejor juego rápido", game: "Azul", icon: Zap },
      { category: "Juego más fácil", game: "Ticket to Ride", icon: Star },
      { category: "Mejor juego familiar", game: "Codenames", icon: Home }
    ]
  };
  ...
  const christineFavorites = {
    avatar: "👩‍🎨",
    name: "Christine",
    description: "Fanática de los cooperativos y party games",
    favorites: [
      { category: "Mejor juego para 2", game: "Splendor Duel", icon: Users },
      { category: "Juego de cartas favorito", game: "6 qui prend", icon: Gamepad2 },
      { category: "Juego de estrategia favorito", game: "Pandemic", icon: Trophy },
      { category: "Mejor juego rápido", game: "Trio", icon: Zap },
      { category: "Juego más fácil", game: "Pelusas", icon: Star },
      { category: "Mejor juego familiar", game: "Catan", icon: Home }
    ]
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Descubre los juegos favoritos de Nil y Christine, actualizados mensualmente con nuestras mejores recomendaciones por categorías." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed">
              Esta es una página personal que actualizamos mensualmente con nuestros juegos de mesa favoritos. 
              Nil y Christine comparten sus elecciones en diferentes categorías basándose en lo que más hemos 
              disfrutado ese mes.
            </p>
          </motion.div>
          ...
          >
            <Card className="glass-effect border-white/10 p-8 max-w-2xl mx-auto">
              ...
              <p className="text-gray-400 mb-6">
                Explora nuestro catálogo completo con reseñas detalladas de todos estos juegos y muchos más.
              </p>
